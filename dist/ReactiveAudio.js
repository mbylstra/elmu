...
Elm.Lib.MutableArray.make = function (_elm) {
   ...
   if (_elm.Lib.MutableArray.values)
   return _elm.Lib.MutableArray.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $ElmTest = Elm.ElmTest.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var push = $Native$MutableArray.push;
   ...
   var fromList = function (list) {
      return $Native$MutableArray.fromList(list);
   };
...
Elm.Lib.StringKeyMutableDict.make = function (_elm) {
   ...
   if (_elm.Lib.StringKeyMutableDict.values)
   return _elm.Lib.StringKeyMutableDict.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var insert = F3(function (key,value,dict) {
      return A3($Native$StringKeyMutableDict.insert,
      key,
      value,
      dict);
   });
   var unsafeNativeGet = F2(function (key,dict) {
      return A2($Native$StringKeyMutableDict.unsafeNativeGet,
      key,
      dict);
   });
...
Elm.Audio.MainTypes.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var applyToBaseProps = F2(function (func,node) {
      var _p0 = node;
      switch (_p0.ctor)
      {case "Dummy": return func(_p0._0._0);
         case "Oscillator": return func(_p0._0._0);
         default: return func(_p0._0._0);}
   });
   var getBaseProps = function (node) {
      return A2(applyToBaseProps,$Basics.identity,node);
   };
   ...
   var updateBasePropsCollectExtra = F2(function (updateFunc,
   audioNode) {
      var _p1 = audioNode;
      switch (_p1.ctor)
      {case "Dummy": var _p2 = updateFunc(_p1._0._0);
           var newBaseProps = _p2._0;
           var extra = _p2._1;
           return {ctor: "_Tuple2"
                  ,_0: Dummy({ctor: "_Tuple2",_0: newBaseProps,_1: _p1._0._1})
                  ,_1: extra};
         case "Oscillator": var _p3 = updateFunc(_p1._0._0);
           var newBaseProps = _p3._0;
           var extra = _p3._1;
           return {ctor: "_Tuple2"
                  ,_0: Oscillator({ctor: "_Tuple2"
                                  ,_0: newBaseProps
                                  ,_1: _p1._0._1})
                  ,_1: extra};
         default: var _p4 = updateFunc(_p1._0._0);
           var newBaseProps = _p4._0;
           var extra = _p4._1;
           return {ctor: "_Tuple2"
                  ,_0: Destination({ctor: "_Tuple2"
                                   ,_0: newBaseProps
                                   ,_1: _p1._0._1})
                  ,_1: extra};}
   });
   var updateBaseProps = F2(function (updateFunc,audioNode) {
      var _p5 = audioNode;
      switch (_p5.ctor)
      {case "Dummy": return Dummy({ctor: "_Tuple2"
                                  ,_0: updateFunc(_p5._0._0)
                                  ,_1: _p5._0._1});
         case "Oscillator": return Oscillator({ctor: "_Tuple2"
                                              ,_0: updateFunc(_p5._0._0)
                                              ,_1: _p5._0._1});
         default: return Destination({ctor: "_Tuple2"
                                     ,_0: updateFunc(_p5._0._0)
                                     ,_1: _p5._0._1});}
   });
   var DummyProps = function (a) {    return {func: a};};
   var OscillatorProps = F2(function (a,b) {
      return {phase: a,func: b};
   });
   var BaseProps = F4(function (a,b,c,d) {
      return {userId: a,autoId: b,inputs: c,outputValue: d};
   });
   ...
   return _elm.Audio.MainTypes.values = {_op: _op
                                        ...
                                        ,AutoID: AutoID
                                        ,BaseProps: BaseProps
                                        ,OscillatorProps: OscillatorProps
                                        ...
                                        ,updateBasePropsCollectExtra: updateBasePropsCollectExtra
                                        ,updateBaseProps: updateBaseProps
                                        ,applyToBaseProps: applyToBaseProps
...
Elm.Audio.Atoms.Destination.make = function (_elm) {
   ...
   if (_elm.Audio.Atoms.Destination.values)
   return _elm.Audio.Atoms.Destination.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var destination = function (userId) {
      return $Audio$MainTypes.Destination({ctor: "_Tuple2"
                                          ,_0: {userId: $Maybe.Nothing
                                               ,autoId: $Maybe.Just("0")
                                               ,inputs: _U.list([$Audio$MainTypes.ID(userId)])
                                               ,outputValue: 0.0}
                                          ,_1: {ctor: "_Tuple0"}});
   };
...
Elm.Audio.Atoms.Sine.make = function (_elm) {
   ...
   if (_elm.Audio.Atoms.Sine.values)
   return _elm.Audio.Atoms.Sine.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   ...
   var sinWave = F2(function (_p0,prevPhase) {
      var _p1 = _p0;
      var _p2 = A2($Debug.log,"prevPhase",prevPhase);
      var amplitude = 0.0;
      var periodSeconds = $Audio$AudioNodeFunctions.getPeriodSeconds(_p1.frequency + _p1.frequencyOffset);
      ...
      var _p3 = A2($Debug.log,"phaseOffset",phaseOffset);
      var _p4 = A2($Debug.log,"phaseOffset",phaseOffset);
      var _p5 = A2($Debug.log,"prevPhase",prevPhase);
      return {ctor: "_Tuple2",_0: amplitude,_1: currPhase};
   });
   var sine = function (args) {
      return $Audio$MainTypes.Oscillator({ctor: "_Tuple2"
                                         ,_0: {userId: args.id
                                              ,autoId: $Maybe.Nothing
                                              ,inputs: _U.list([args.frequency
                                                               ,args.frequencyOffset
                                                               ,args.phaseOffset])
                                              ,outputValue: 0.0}
                                         ,_1: {func: sinWave,phase: 0.0}});
   };
...
Elm.Lib.ListExtra.make = function (_elm) {
   ...
   var unsafeHead = function (l) {
      ...
      if (_p0.ctor === "Just") {
            ...
            return _U.crashCase("Lib.ListExtra",
            {start: {line: 5,column: 3},end: {line: 7,column: 69}},
            _p0)("unsafeHead was called on an empty list!");
         }
   };
...
Elm.Audio.FlattenGraph.make = function (_elm) {
   ...
   if (_elm.Audio.FlattenGraph.values)
   return _elm.Audio.FlattenGraph.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Audio$MainTypes = Elm.Audio.MainTypes.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var dummy2 = $Audio$MainTypes.Dummy({ctor: "_Tuple2"
                                       ,_0: {userId: $Maybe.Just("dummy2")
                                            ,autoId: $Maybe.Nothing
                                            ,inputs: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                                             ,_0: "inputA"
                                                                             ,_1: $Audio$MainTypes.Node($Audio$MainTypes.Dummy({ctor: "_Tuple2"
                                                                                                                               ,_0: {userId: $Maybe.Just("dummy3")
                                                                                                                                    ,autoId: $Maybe.Nothing
                                                                                                                                    ,inputs: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                                                                                                                                     ,_0: "inputA"
                                                                                                                                                                     ,_1: $Audio$MainTypes.Node($Audio$MainTypes.Dummy({ctor: "_Tuple2"
                                                                                                                                                                                                                       ,_0: {userId: $Maybe.Just("dummy4")
                                                                                                                                                                                                                            ,autoId: $Maybe.Nothing
                                                                                                                                                                                                                            ,inputs: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                                                                                                                                                                                                                             ,_0: "inputA"
                                                                                                                                                                                                                                                             ,_1: $Audio$MainTypes.ID("dummy1")}]))
                                                                                                                                                                                                                            ,outputValue: 0.0}
                                                                                                                                                                                                                       ,_1: {func: 0.0}}))}]))
                                                                                                                                    ,outputValue: 0.0}
                                                                                                                               ,_1: {func: 0.0}}))}]))
                                            ,outputValue: 0.0}
                                       ,_1: {func: 0.0}});
   var dummy1 = $Audio$MainTypes.Dummy({ctor: "_Tuple2"
                                       ,_0: {userId: $Maybe.Just("dummy1")
                                            ,autoId: $Maybe.Nothing
                                            ,inputs: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                                             ,_0: "inputA"
   ...
   var updateDestinationNode = function (nodes) {
      var updateDestinationNode$ = F2(function (prevNodes,
      remainderNodes) {
         updateDestinationNode$: while (true) {
            var _p0 = remainderNodes;
            if (_p0.ctor === "[]") {
                  return _U.crashCase("Audio.FlattenGraph",
                  {start: {line: 210,column: 7},end: {line: 222,column: 83}},
                  _p0)("no nodes of type Destination were found");
               } else {
                  var _p4 = _p0._1;
                  var _p3 = _p0._0;
                  var _p2 = _p3;
                  if (_p2.ctor === "Destination" && _p2._0.ctor === "_Tuple2") {
                        var newBaseProps = _U.update(_p2._0._0,
                        ...
                        var _v2 = A2($Basics._op["++"],prevNodes,_U.list([_p3])),
                        _v3 = _p4;
                        prevNodes = _v2;
                        remainderNodes = _v3;
   ...
   var convertUserIdInputs = function (nodes) {
      var getAutoIdForUserId = function (userId) {
         var filter = function (node) {
            var currMaybeUserId = function (_) {
               return _.userId;
            }($Audio$MainTypes.getBaseProps(node));
         ...
         var foundNode = $Lib$ListExtra.unsafeHead(A2($List.filter,
         filter,
         nodes));
         return A2($Maybe.withDefault,
         "Nothing",
      ...
      var convertInput = function (inputTuple) {
         ...
         if (_p6.ctor === "_Tuple2" && _p6._1.ctor === "ID") {
               return {ctor: "_Tuple2"
                      ,_0: _p6._0
                      ,_1: $Audio$MainTypes.AutoID(getAutoIdForUserId(_p6._1._0))};
            } else {
               return inputTuple;
            }
      };
      ...
      var convertNodeUserIdInputs = function (node) {
         return A2($Audio$MainTypes.updateBaseProps,
         convertUserIdInputs$,
         node);
      };
   ...
   var flatNodeListToDict = function (nodes) {
      ...
      function (node) {
         return {ctor: "_Tuple2"
                ,_0: $Audio$MainTypes.getNodeAutoId(node)
                ,_1: node};
      },
      nodes));
   };
   var flattenNode = F3(function (node,oldLastId,oldAccNodes) {
      var updateBasePropsFunc = function (oldProps) {
         var inputNames = $Dict.keys(oldProps.inputs);
         var _p7 = A2(doInputs,
         inputNames,
         {props: oldProps
         ,lastId: oldLastId
         ,accNodes: oldAccNodes
         ,node: node});
         var props = _p7.props;
      ...
      var _p8 = A2($Audio$MainTypes.updateBasePropsCollectExtra,
      updateBasePropsFunc,
      node);
      var newNode = _p8._0;
      var accNodes2 = _p8._1._0;
      var id = _p8._1._1;
      return {lastId: id
             ,nodes: A2($Basics._op["++"],accNodes2,_U.list([newNode]))};
   });
   var doInputs = F2(function (currInputNames,_p9) {
      doInputs: while (true) {
         var _p10 = _p9;
         var _p15 = _p10.node;
         var _p14 = _p10.lastId;
         var _p13 = _p10.accNodes;
         var _p11 = currInputNames;
         if (_p11.ctor === "[]") {
               return {props: _p10.props,lastId: _p14,accNodes: _p13};
            } else {
               var _p12 = flattenInputTop({inputName: _p11._0
                                          ,node: _p15
                                          ,lastId: _p14
                                          ,accNodes: _p13});
               var props = _p12.props;
               var lastId = _p12.lastId;
               var accNodes = _p12.accNodes;
               var _v8 = _p11._1,
               _v9 = {props: props
                     ,lastId: lastId
                     ,accNodes: accNodes
   ...
   var flattenInputTop = function (_p16) {
      var _p17 = _p16;
      var oldProps = $Audio$MainTypes.getBaseProps(_p17.node);
      var _p18 = flattenInputUpperMiddle({inputName: _p17.inputName
                                         ,props: oldProps
                                         ,lastId: _p17.lastId
                                         ,accNodes: _p17.accNodes});
      var props = _p18.props;
      var accNodes = _p18.accNodes;
      var lastId = _p18.lastId;
      return {accNodes: accNodes,lastId: lastId,props: props};
   };
   var flattenInputUpperMiddle = function (_p19) {
      var _p20 = _p19;
      var _p23 = _p20.props;
      var _p22 = _p20.inputName;
      var _p21 = flattenInputMiddle({accNodes: _p20.accNodes
                                    ,lastId: _p20.lastId
                                    ,input: A2($Lib$Misc.unsafeDictGet,_p22,_p23.inputs)
                                    ,inputName: _p22
                                    ,inputs: _p23.inputs});
      var lastId = _p21.lastId;
      var accNodes = _p21.accNodes;
      var inputs = _p21.inputs;
      var newProps = _U.update(_p23,{inputs: inputs});
      return {props: newProps,accNodes: accNodes,lastId: lastId};
   };
   var flattenInputMiddle = function (_p24) {
      var _p25 = _p24;
      var _p30 = _p25.lastId;
      var _p29 = _p25.inputs;
      var _p28 = _p25.accNodes;
      var _p26 = flattenInputLower({accNodes: _p28
                                   ,lastId: _p30
                                   ,input: _p25.input});
      if (_p26.ctor === "Just") {
            var _p27 = _p26._0.lastId;
            return {lastId: _p27
                   ,accNodes: _p26._0.nodes
                   ,inputs: A3($Dict.insert,
                   _p25.inputName,
                   $Audio$MainTypes.AutoID($Basics.toString(_p27)),
                   _p29)};
         } else {
            return {lastId: _p30,accNodes: _p28,inputs: _p29};
         }
   };
   var flattenInputLower = function (_p31) {
      var _p32 = _p31;
      var _p33 = _p32.input;
      if (_p33.ctor === "Node") {
   ...
   var flattenNodeList = function (nodes) {
      ...
      lastId) {
         flattenNodeList$: while (true) {
            var _p34 = remainderNodes;
            if (_p34.ctor === "[]") {
                  return {ctor: "_Tuple2",_0: lastId,_1: outputNodes};
               } else {
                  var r = A3(flattenNode,_p34._0,lastId,_U.list([]));
                  var _p35 = {ctor: "_Tuple2"
                             ,_0: r.lastId
                             ,_1: A2($Basics._op["++"],outputNodes,r.nodes)};
                  var lastId2 = _p35._0;
                  var outputNodes2 = _p35._1;
                  var _v17 = _p34._1,_v18 = outputNodes2,_v19 = lastId2;
                  remainderNodes = _v17;
                  outputNodes = _v18;
                  lastId = _v19;
      ...
      var _p36 = A3(flattenNodeList$,nodes,_U.list([]),0);
      var outputNodes3 = _p36._1;
      return outputNodes3;
   };
   var tests = A2($ElmTest.suite,
   "",
   _U.list([A2($ElmTest.test,
           ...
           4,
           function () {
              var result = convertUserIdInputs(flattenNodeList(_U.list([dummy1
                                                                       ,dummy2])));
...
Elm.Gui.ColorScheme.make = function (_elm) {
   ...
   var fromColourLovers = function (palette) {
      ...
      {windowBackground: A2($Maybe.withDefault,
   ...
   var fromColourLoversArray = function (palettes) {
      return A2($Array.map,fromColourLovers,palettes);
   };
...
Elm.Gui.ColorSchemeChooser.make = function (_elm) {
   ...
   var colorSchemeView = F3(function (address,index,colorScheme) {
      ...
      var colors = A2($List.map,
      function (field) {
         return field(colorScheme);
      },
      fields);
      return A2($Html.div,
...
Elm.Gui.KnobRegistry.make = function (_elm) {
   ...
   var encode = function (model) {
      return $Dict.toList(A2($Dict.map,
      F2(function (k,v) {    return $Gui$Knob.encode(v);}),
      model.knobs));
   };
   var getKnob = F2(function (knobs,id) {
      ...
      if (_p6.ctor === "Just") {
            ...
            {start: {line: 45,column: 3},end: {line: 47,column: 61}},
            _p6)(A2($Basics._op["++"],"No knob exists with id: ",id));
         }
   });
   var getKnobValue = F2(function (model,id) {
   ...
   var init = function (knobSpecs) {
      return {knobs: $Dict.fromList(A2($List.map,
             function (_p8) {
                var _p9 = _p8;
                return {ctor: "_Tuple2",_0: _p9._0,_1: $Gui$Knob.init(_p9._1)};
             },
             knobSpecs))
             ,currentKnob: $Maybe.Nothing
...
Elm.Gui.make = function (_elm) {
   ...
   var _op = {};
   var bufferSize = 1024;
   var bufferSizePort = Elm.Native.Port.make(_elm).outbound("bufferSizePort",
   function (v) {
      return v;
   },
   bufferSize);
   ...
   var getAttack = function (model) {
      return A2($Gui$KnobRegistry.getKnobValue,
      model.knobRegistry,
      "attack");
   };
   var getFrequency = function (model) {
...
Elm.Orchestrator.make = function (_elm) {
   ...
   var getInputHelper = F3(function (ui,graph,input) {
      var _p0 = input;
      switch (_p0.ctor)
      {case "Value": return ValueInput(_p0._0);
         case "Default": return ValueInput(0.0);
         case "UI": return ValueInput(_p0._0(ui));
         case "AutoID": var _p1 = A2($Lib$StringKeyMutableDict.get,
           _p0._0,
           graph);
           if (_p1.ctor === "Just") {
                 ...
                 {start: {line: 230,column: 7},end: {line: 234,column: 115}},
         ...
         case "Node": return _U.crashCase("Orchestrator",
           {start: {line: 222,column: 3},end: {line: 238,column: 101}},
   ...
   var getInputValue = F3(function (uiModel,graph,input) {
      var _p5 = A3(getInputHelper,uiModel,graph,input);
      if (_p5.ctor === "ValueInput") {
            return {ctor: "_Tuple2",_0: _p5._0,_1: graph};
         } else {
            return A3(updateNode,uiModel,graph,_p5._0);
         }
   });
   var updateNode = F3(function (uiModel,graph,node) {
      var _p6 = node;
      _v3_2: do {
         switch (_p6.ctor)
         {case "Oscillator": if (_p6._0.ctor === "_Tuple2") {
                    var newNode = node;
                    var newValue = 0.0;
                    var inputs = _p6._0._0.inputs;
                    var _p7 = A2($Debug.log,"inputs",inputs);
      ...
      return _U.crashCase("Orchestrator",
      {start: {line: 72,column: 3},end: {line: 129,column: 25}},
      _p6)("");
   });
   var getInputValues = F3(function (uiModel,graph,inputs) {
      var _p12 = A2($Debug.log,"inputs",inputs);
      var inputValues = $Lib$MutableArray.empty;
      var getInputValues$ = F2(function (graph2,remainderInputs) {
         getInputValues$: while (true) {
            var _p13 = remainderInputs;
            if (_p13.ctor === "[]") {
                  return graph2;
               } else {
                  var _p14 = A3(getInputValue,uiModel,graph2,_p13._0);
                  var value = _p14._0;
                  var graph3 = _p14._1;
                  var _p15 = A2($Lib$MutableArray.push,value,inputValues);
                  var _v5 = graph3,_v6 = _p13._1;
                  graph2 = _v5;
                  remainderInputs = _v6;
                  continue getInputValues$;
               }
         }
      });
      var graph4 = A2(getInputValues$,graph,inputs);
      var _p16 = A2($Debug.log,"inputs",inputs);
      return {ctor: "_Tuple2",_0: inputValues,_1: graph4};
   });
   var updateGraph = F2(function (uiModel,graph) {
      return A3(updateNode,
      uiModel,
      graph,
...
Elm.BufferHandler.make = function (_elm) {
   ...
   var updateForSample = F2(function (uiModel,_p0) {
      var _p1 = _p0;
      var newBufferIndex = _p1.bufferIndex + 1;
      var newTime = _p1.time + sampleDuration;
      var _p2 = A2($Orchestrator.updateGraph,uiModel,_p1.graph);
      var value = _p2._0;
      var newGraph = _p2._1;
      return {time: newTime
             ,graph: newGraph
   ...
   var updateBufferState = F2(function (uiModel,prevBufferState) {
      ...
      var initialBufferState = {time: time
                               ...
                               ,bufferIndex: 0};
      return A3(foldn,
      updateForSample(uiModel),
      initialBufferState,
      $Gui.bufferSize);
   });
   var initialState = {time: 0.0
                      ,graph: $Dict.fromList(_U.list([]))
...
Elm.ReactiveAudio.make = function (_elm) {
   ...
   var audioGraph = $Audio$FlattenGraph.flattenGraph(basicGraph);
