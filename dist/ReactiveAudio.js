...
Elm.Orchestrator.make = function (_elm) {
   ...
   var getDestinationNode = function (graph) {
      ...
      if (_p2.ctor === "Just") {
            ...
            {start: {line: 233,column: 9},end: {line: 237,column: 78}},
   ...
   var getInputNodes = F2(function (node,graph) {
      var getInputNode$ = function (input) {
         ...
         if (_p6.ctor === "Just") {
               ...
               return _U.crashCase("Orchestrator",
               {start: {line: 149,column: 21},end: {line: 151,column: 66}},
               _p6)("Can\'t find node");
            }
      };
   ...
   var updateGraph = F2(function (graph,time) {
      return {ctor: "_Tuple2",_0: graph,_1: time};
   });
   ...
   var updateGraphNode = F3(function (graph,time,node) {
      ...
      {case "Generator": var newValue = _p15._0.$function(time);
         ...
         case "FeedforwardProcessor": var _p21 = _p15._0;
           ...
           if (_p17.ctor === "Just") {
                 if (_p17._0.ctor === "::" && _p17._0._1.ctor === "[]") {
                       ...
                       return _U.crashCase("Orchestrator",
                       {start: {line: 110,column: 17},end: {line: 121,column: 55}},
         ...
         case "Destination": var _p22 = A2(getInputNodes,node,graph);
           if (_p22.ctor === "Just") {
                 if (_p22._0.ctor === "::" && _p22._0._1.ctor === "[]") {
                       ...
                       return _U.crashCase("Orchestrator",
                       {start: {line: 125,column: 17},end: {line: 136,column: 55}},
         ...
         default: return _U.crashCase("Orchestrator",
           {start: {line: 100,column: 9},end: {line: 138,column: 66}},
...
Elm.ReactiveAudio.make = function (_elm) {
   ...
   var updateBufferState = F2(function (_p0,prevBufferState) {
      var updateForSample = function (_p1) {
         ...
         return {time: time
                ,graph: newGraph
                ,buffer: A2($Basics._op["++"],_p2.buffer,_U.list([value]))};
      };
   ...
   bufferStateSignal));
   var BufferState = F3(function (a,b,c) {
      return {time: a,graph: b,buffer: c};
   });
