...
Elm.Lib.GenericMutableDict.make = function (_elm) {
   ...
   if (_elm.Lib.GenericMutableDict.values)
   return _elm.Lib.GenericMutableDict.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var insert = F3(function (key,value,dict) {
      return A3($Native$GenericMutableDict.insert,key,value,dict);
   });
   var unsafeNativeGet = F2(function (key,dict) {
      return A2($Native$GenericMutableDict.unsafeNativeGet,
      key,
      dict);
   });
   var fromList = function (list) {
      return $Native$GenericMutableDict.fromList(list);
   };
   var empty = $Native$GenericMutableDict.empty;
   var GenericMutableDict = {ctor: "GenericMutableDict"};
   return _elm.Lib.GenericMutableDict.values = {_op: _op
                                               ,empty: empty
                                               ,insert: insert
                                               ,unsafeNativeGet: unsafeNativeGet
                                               ,fromList: fromList};
...
Elm.Audio.MainTypes.make = function (_elm) {
   ...
   var initialiseOscillatorProps = function (_p1) {
      var _p2 = _p1;
      return $Lib$GenericMutableDict.fromList(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "phase"
                                                       ,_1: 0.0}]));
   };
   var Dummy = F2(function (a,b) {
      return {ctor: "Dummy",_0: a,_1: b};
   });
   ...
   var updateConstantBasePropsCollectExtra = F2(function (updateFunc,
   audioNode) {
      var _p3 = audioNode;
      switch (_p3.ctor)
      {case "Dummy": var _p4 = updateFunc(_p3._0);
           ...
           var extra = _p4._1;
           return {ctor: "_Tuple2"
                  ,_0: A2(Dummy,newConstantBaseProps,_p3._1)
                  ,_1: extra};
         case "Oscillator": var _p5 = updateFunc(_p3._1);
           var newConstantBaseProps = _p5._0;
           var extra = _p5._1;
           return {ctor: "_Tuple2"
                  ,_0: A4(Oscillator,_p3._0,newConstantBaseProps,_p3._2,_p3._3)
                  ,_1: extra};
   ...
   audioNode) {
      ...
      {case "Dummy": return A2(Dummy,updateFunc(_p8._0),_p8._1);
         case "Oscillator": return A4(Oscillator,
           _p8._0,
           updateFunc(_p8._1),
           _p8._2,
           _p8._3);
   ...
   var ConstantBaseProps = F3(function (a,b,c) {
      return {userId: a,autoId: b,inputs: c};
   });
...
Elm.Audio.Atoms.Adder.make = function (_elm) {
   ...
   if (_elm.Audio.Atoms.Adder.values)
   return _elm.Audio.Atoms.Adder.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var adder = function (inputs) {
      return A2(namedAdder,"",inputs);
   };
   return _elm.Audio.Atoms.Adder.values = {_op: _op
                                          ,add: add
...
Elm.Audio.FlattenGraph.make = function (_elm) {
      ...
      remainderNodes) {
         updateDestinationNode$: while (true) {
            ...
            if (_p0.ctor === "[]") {
                  ...
                  {start: {line: 228,column: 7},end: {line: 240,column: 83}},
      ...
      var getAutoIdForUserId = function (userId) {
         var filter = function (node) {
            var currMaybeUserId = function (_) {
               return _.userId;
            }($Audio$MainTypes.getConstantBaseProps(node));
         ...
         function (_) {
            return _.autoId;
         }($Audio$MainTypes.getConstantBaseProps(foundNode)));
      };
   ...
   var flattenNode = F3(function (node,oldLastId,oldAccNodes) {
      ...
      var _p9 = A2($Audio$MainTypes.updateConstantBasePropsCollectExtra,
      updateConstantBasePropsFunc,
      node);
      var newNode = _p9._0;
   ...
   var doInputs = F2(function (currInputNames,_p10) {
      doInputs: while (true) {
         ...
         if (_p12.ctor === "[]") {
               return {props: _p11.props,lastId: _p14,accNodes: _p13};
            } else {
   ...
   var flattenInputTop = function (_p16) {
      var _p17 = _p16;
      var oldProps = $Audio$MainTypes.getConstantBaseProps(_p17.node);
   ...
   var flattenInputMiddle = function (_p24) {
      var _p25 = _p24;
      var _p34 = _p25.lastId;
      var _p33 = _p25.inputs;
      var _p32 = _p25.inputName;
      var _p31 = _p25.accNodes;
      var _p26 = A2($Debug.log,"flattenInputMiddle inputs",_p33);
      var _p27 = flattenInputLower({accNodes: _p31
                                   ,lastId: _p34
                                   ,input: _p25.input});
      if (_p27.ctor === "Just") {
            var _p30 = _p27._0.lastId;
            var newInputs = A3($Dict.insert,
            _p32,
            $Audio$MainTypes.AutoID($Basics.toString(_p30)),
            _p33);
            var _p28 = A2($Debug.log,"flattenInputMiddle iputName",_p32);
            var _p29 = A2($PrettyDebug.log,
            "flattenInputMiddle newInputs",
            newInputs);
            return {lastId: _p30,accNodes: _p27._0.nodes,inputs: newInputs};
         } else {
            return {lastId: _p34,accNodes: _p31,inputs: _p33};
         }
   };
   var flattenInputLower = function (_p35) {
      var _p36 = _p35;
      var _p37 = _p36.input;
      if (_p37.ctor === "Node") {
      ...
      lastId) {
         flattenNodeList$: while (true) {
            ...
            if (_p38.ctor === "[]") {
                  ...
                  var _v17 = _p38._1,_v18 = outputNodes2,_v19 = lastId2;
                  remainderNodes = _v17;
                  outputNodes = _v18;
                  lastId = _v19;
...
Elm.Orchestrator.make = function (_elm) {
      ...
      {case "Value": return ValueInput(_p0._0);
         ...
         case "AutoID": var _p1 = A2($Lib$StringKeyMutableDict.get,
           ...
           if (_p1.ctor === "Just") {
                 ...
                 {start: {line: 210,column: 7},end: {line: 214,column: 115}},
         ...
         case "Node": return _U.crashCase("Orchestrator",
           {start: {line: 202,column: 3},end: {line: 218,column: 101}},
   ...
   var updateNode = F3(function (uiModel,graph,node) {
      ...
      {case "Oscillator": var _p12 = _p7._3;
         ...
         var id = $Audio$MainTypes.getNodeAutoId(node);
           ...
           var _p14 = A3(getInputValues,uiModel,graph,inputs);
           ...
           return {ctor: "_Tuple2",_0: newValue,_1: graph3};
         default: return _U.crashCase("Orchestrator",
           {start: {line: 89,column: 5},end: {line: 166,column: 27}},
           _p7)("");}
   });
   var getInputValues = F3(function (uiModel,graph,inputs) {
      var update = F3(function (inputName,input,acc) {
         var _p17 = acc;
         var inputValues = _p17._0;
         var graph2 = _p17._1;
         var _p18 = A3(getInputValue,uiModel,graph2,input);
         var value = _p18._0;
         var graph3 = _p18._1;
   ...
   var updateGraph = F2(function (uiModel,graph) {
      ...
      return A3(updateNode,uiModel,graph,destinationNode);
   });
   var ExternalState = F2(function (a,b) {
      return {time: a,externalInputState: b};
   });
...
Elm.BufferHandler.make = function (_elm) {
   ...
   var updateForSample = F2(function (uiModel,_p1) {
      ...
      var _p3 = A2($Orchestrator.updateGraph,uiModel,_p2.graph);
      var value = _p3._0;
      var newGraph = _p3._1;
      return {time: newTime
             ,graph: newGraph
